...
function buildAliasMap(config: PdfExtractorConfig): AliasMap {
  return {
    ...
    "@pdf-extractor/utils": `${config.aliases.libDir}/cn`,
    "@pdf-extractor/data-table": `${config.aliases.componentsDir}/data-table`,
    "@pdf-extractor/rules-panel": `${config.aliases.componentsDir}/rules-panel`,
    "@pdf-extractor/xlsx-import": `${config.aliases.componentsDir}/xlsx-import`,
    "@pdf-extractor/data-view": `${config.aliases.componentsDir}/data-view`,
    "@pdf-extractor/table-overlay": `${config.aliases.componentsDir}/table-overlay`,
    "@pdf-extractor/ignore-overlay": `${config.aliases.componentsDir}/ignore-overlay`,
    "@pdf-extractor/output-panel": `${config.aliases.componentsDir}/output-panel`,
    "@pdf-extractor/pdf-viewer": `${config.aliases.componentsDir}/pdf-viewer`,
  };
}
